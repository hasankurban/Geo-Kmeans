...
for i in range(len(file_dicts.keys())):
    ...
    for i_seed in seeds:
        ...
        centroids2, iter2 = Kmeans(data, num_clusters, threshold, num_iterations, centroids1, False, i_seed)
        # out = KMeans(n_clusters=num_clusters).fit(data)
