...
string basePath = "/Users/schmuck/Documents/Box Sync/PhD/DATASETS/real_data/";
...
int main(){
    ...
    //    int time_limit = 3000000;
       ...
       ofstream avgresFile;
       string outFile = out_path + "doubling_experiments234.csv" ;
       ...
       algorithm_utils alg_utils;
        ...
        for(int i=0; i < file_list.size(); i++){
                ...
                for (int j = 0; j<data_prop.size(); j++){
                    ...
                    string tempFile1 = out_path + "km_" + to_string(prop) +".csv" ;
                    string tempFile2 = out_path + "ballkm_" + to_string(prop) +".csv" ;
                    ...
                    cout << extracted_data.size() << endl;  
                    // print_utils pu;
                    // print_2d_vector(extracted_data, 2, "extracted");
                    ...
                    km_res.runtime << " " << dckm_res.runtime << " " << ballkm_res.runtime << endl;
