...
int main(int argc, char* argv[]) {
    ...
    MatrixOur dataset = load_data("/nobackup/parishar/DATASETS/scal_data/1000000_points.csv");

    auto t3 = std::chrono::high_resolution_clock::now();
    VectorXi labels = ball_k_means(dataset, num_clusters, true, false, -1, thres, iters, "0");
