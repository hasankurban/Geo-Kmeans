...
//     // MatrixOur dataset = load_data("/nobackup/parishar/DATASETS/scal_data/spambase.csv");

//     auto t3 = std::chrono::high_resolution_clock::now();
//     VectorXi labels = ball_k_means(dataset, num_clusters, true, true, -1, thres, iters, "0");
