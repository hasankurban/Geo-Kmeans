...
//             for (j=0; j<new_centroids(i).norm(); j++)
...
// VectorXi ball_k_means_Ring(MatrixOur& dataset, MatrixOur& centroids, bool detail = false, double thres = 0.0001) {
...
//         // delta = (((new_centroids - old_centroids).square()).sum()).sqrt();
...
//                       int random_seed = -1, const char* filename = "0", double thres = 0.0001) {
//     MatrixOur centroids;
//     if (filename == "0") {
...
//     VectorXi labels;
//     if (isRing) {
//         labels = ball_k_means_Ring(dataset, centroids, detail, thres);
//     }
//     else {
...
//     MatrixOur dataset = load_data("/Users/schmuck/Library/CloudStorage/OneDrive-IndianaUniversity/Box Sync/PhD/DATASETS/real_data/ijcnn.csv");

//     auto t3 = std::chrono::high_resolution_clock::now();
//     VectorXi labels = ball_k_means(dataset, 30, true, true, -1, "/Users/schmuck/Library/CloudStorage/OneDrive-IndianaUniversity/Box Sync/PhD/DATASETS/real_data/ijcnn_cen.csv", thres);
